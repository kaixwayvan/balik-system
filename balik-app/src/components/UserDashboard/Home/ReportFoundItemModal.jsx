...
export default function ReportFoundItemModal({ onClose }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log("Found Item Report Saved Successfully");
      onClose();
    } catch (error) {
    ...
    >
      <div className="bg-white w-full max-w-5xl max-h-[90vh] overflow-y-auto seamless-scrollbar rounded-[3rem] shadow-2xl relative">
        ...
        <div className="sticky top-0 bg-white/80 backdrop-blur-md px-10 py-6 border-b border-slate-100 flex justify-between items-center z-20">
          <div>
            <h2 className="text-3xl font-black text-slate-900">Report Found Item</h2>
            <p className="text-slate-500 text-sm">Help someone find their lost belonging.</p>
          </div>
          <button 
            onClick={onClose} 
          ...
          <form onSubmit={handleSubmit} className="space-y-10">
            ...
            <div className="flex flex-col gap-3">
              ...
              <textarea 
                ...
                placeholder="Any specific markings or content inside..." 
              />
            </div>
            ...
            <div className="flex justify-center gap-4 pt-8 pb-4">
              ...
              <button 
                ...
                className="bg-blue-600 text-white font-black py-5 px-16 rounded-full shadow-xl hover:bg-blue-700 hover:-translate-y-1 transition-all active:scale-95 uppercase tracking-widest text-lg"
              >
