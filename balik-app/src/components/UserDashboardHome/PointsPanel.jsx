export default function PointsPanel() {
  return (
    <div className="bg-indigo-900 text-white rounded-xl p-6 shadow">
      ...
      <p className="text-sm mt-1">Level 1: Seeker Status</p>
      <div className="mt-4">
        <div className="h-2 bg-indigo-700 rounded-full">
          <div className="h-2 bg-yellow-400 rounded-full w-1/3"></div>
        </div>
        <p className="text-xs mt-1">890 more points to go</p>
      </div>
    </div>
  );
}