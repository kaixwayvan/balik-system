...
export default function PrivacyPolicy() {
  ...
  return (
    <div className="min-h-screen bg-[#FDF8F5] font-sans text-slate-900 selection:bg-[#F2E4DC] selection:text-[#520000] overflow-x-hidden relative">
      <Header />
      {/* Top Header Background Elements - Solid White */}
      <div className="absolute top-0 left-0 w-full h-[130px] bg-white border-b border-[#B0570C]/40 overflow-hidden pointer-events-none z-30">
        {/* The 'bg-white' above is already solid. 
      To ensure the blurs don't make it look 'off-white', 
      you can adjust their opacities or colors. */}
      ...
      {/* HERO SECTION */}
      <div className="relative w-full h-[400px] overflow-hidden flex flex-col items-center justify-center pt-20 border-b border-gray-200">
        {/* Decorative Background Elements - Ensure they are absolute and z-0 */}
        <div className="absolute inset-0 pointer-events-none z-0">
          {/* Top Left Shape */}
          <div
            className="absolute top-[-10px] left-[-20px] w-[600px] h-[300px] bg-[#d9d4f0] rounded-[50px] rotate-[-10deg] shadow-inner opacity-60"
            style={{ clipPath: "polygon(0 0, 100% 0, 80% 100%, 0% 100%)" }}
          ></div>

          {/* Bottom Right Shape */}
          <div
            className="absolute bottom-[-90px] right-[-50px] w-[700px] h-[300px] bg-[#d9d4f0] rounded-[60px] shadow-inner opacity-60"
            style={{
          ...
          <div className="font-['Zalando_Sans_Expanded'] absolute top-[120px] left-[6%] text-[100px] font-black text-[#d9d4f0] transform -rotate-12 opacity-30 select-none tracking-tighter">
            LOST
          </div>

          {/* Background Text "FOUND" */}
          <div className="font-['Zalando_Sans_Expanded'] absolute bottom-[40px] right-[10%] text-[110px] font-black text-[#d9d4f0] opacity-40 select-none tracking-tighter" style={{
        ...
        {/* CONTENT - Raised to z-10 to stay above the shapes */}
        <div className="relative z-10 text-center px-6 mt-8 bg-white/40 backdrop-blur-md py-8 px-14 rounded-[3rem] border border-white/50 shadow-sm">
          <h1 className="text-5xl md:text-[54px] font-black tracking-tight text-[#333333] mb-3">
            Privacy Policy
          </h1>
          ...
          <aside className="lg:w-80 flex-shrink-0 relative bg-[#F2E4DC]/40 backdrop-blur-md rounded-[2rem] border border-[#F2E4DC] shadow-xl shadow-slate-200/30 overflow-hidden">
            <div className="sticky top-32 p-2 h-fit">
              <div className="p-6 pb-2">
                <p className="text-[10px] font-black text-[#520000]/40 uppercase tracking-[0.2em] mb-4">
                  On this page
                </p>
              </div>
          ...
          <article className="flex-1 max-w-4xl space-y-24 pb-32">
            ...
            <section className="bg-white rounded-[2.5rem] p-10 md:p-14 shadow-[0_20px_50px_rgba(0,0,0,0.03)] border border-[#DBC9C0]/30">
              ...
              <div className="space-y-6 text-lg leading-relaxed text-gray-700">
                <p>
                  BALIK (Belongings Assistance Lost Item Keeper) is a
            ...
            <section id="contact" className="scroll-mt-32">
              <div className="bg-white rounded-[2.5rem] p-12 text-center border border-[#DBC9C0]/20 shadow-xl shadow-[#520000]/[0.03] relative overflow-hidden">
                ...
                <h3 className="text-3xl font-black text-[#520000] mb-6">
                ...
                <p className="italic font-bold text-[#520000]">
