      ...
      <header className="absolute top-0 left-0 w-full z-50">
        ...
        <nav className="w-full flex items-center justify-between px-10 py-5 border-b border-gray-400 bg-transparent">
          ...
          <div className="flex items-center gap-10">
            <Link
              to="/"
              className="text-[16px] font-black text-[#2a2a2a] hover:text-[#b89060] transition-colors tracking-[0.1em]"
            >
              HOME
            </Link>
            <Link
            ...
            <Link
              to="/login"
              className="text-[16px] font-black text-[#b89060] border-[1.5px] border-[#b89060] px-8 py-2.5 rounded-full hover:bg-[#b89060] hover:text-white transition-all tracking-[0.1em] ml-2"
            >
              LOG IN
            </Link>
          </div>
