      ...
      <div className="flex justify-center sm:justify-start shrink-0">
        <div className="relative flex items-center bg-slate-100/80 p-1.5 rounded-3xl w-full sm:w-auto shadow-inner border border-slate-200/60">
          ...
          <button
            ...
            className={`cursor-pointer relative flex-1 sm:flex-none flex items-center justify-center gap-2.5 px-6 py-3 rounded-2xl text-md font-bold transition-colors duration-300 z-10 ${
              activeTab === "overview" ? "text-[#5C1313]" : "text-slate-500 hover:text-slate-800"
            }`}
          >
            {activeTab === "overview" && (
              <motion.div
            ...
            <LayoutDashboard size={18} className="relative z-10" strokeWidth={2.5} />
            <span className="relative z-10 tracking-tight">Overview & Actions</span>
          </button>

          <button
            onClick={() => setActiveTab("reports")}
            className={`cursor-pointer relative flex-1 sm:flex-none flex items-center justify-center gap-2.5 px-6 py-3 rounded-2xl text-md font-bold transition-colors duration-300 z-10 ${
              activeTab === "reports" ? "text-[#5C1313]" : "text-slate-500 hover:text-slate-800"
            }`}
          >
            {activeTab === "reports" && (
              <motion.div
            ...
            <FileText size={18} className="relative z-10" strokeWidth={2.5} />
