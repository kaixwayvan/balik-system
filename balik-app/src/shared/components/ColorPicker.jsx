  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="w-full flex items-center justify-between border border-slate-200 rounded-xl px-4 py-4 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-red-100 transition-all outline-none"
      >
