      ...
      <nav className="flex-1 bg-[#3A3B67] border-t border-gray-300 shadow-lg overflow-y-auto -mt-[11px]">
        <div className="flex flex-col min-h-full">
          ...
          <div className="flex flex-col flex-1">
            ...
            <NavLink to="/admin/user-manage" end className={linkClass}>
              <Users size={18} />
              User Management
            </NavLink>
            ...
            <NavLink to="/admin/activity-logs" end className={linkClass}>
              <ScrollText size={18} />
              Activity Logs
            </NavLink>

            <NavLink to="/admin/profile" end className={linkClass}>
              <Settings size={18} />
              Settings
            </NavLink>
          </div>
